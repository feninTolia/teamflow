...
import HeroDark from '@/public/dark-skreenshot.png';
import HeroLight from '@/public/light-screenshot.png';
import BackgroundImage from '@/public/night-bg.webp';
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  is realtime, and uses Al to keep teams in sync.
                </TextEffect>
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            ...
            <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              ...
              <div className="flex">
                <Image
                  className="mx-auto h-5 object-contain dark:invert-0 invert"
                  src={MotionLogo}
                  alt="Motion Logo"
                />
              </div>
              ...
              <div className="flex">
                <Image
                  className="mx-auto h-7 object-contain dark:invert-50"
                  src={PrismaLogo}
                  alt="Prisma Logo"
                />
              </div>
